...
mod linux {
    ...
    fn build(tw: u32, th: u32, key: &str) -> Option<Vec<FbFrame>> {
        // key is one url, a '\n'-joined overlay stack, and/or a `#fx` line —
        // composite_frames handles all of it. wide stacks get a 2x-cell canvas.
        let tw = tw * (crate::emote::render::key_width(key) / EMOTE_W) as u32;
